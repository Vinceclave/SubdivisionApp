namespace Subdivision.Data
{
    ...
    public class SubdivisionDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasOne(u => u.Admin).WithOne(a => a.User).HasForeignKey<Admin>(a => a.LoginId);
            modelBuilder.Entity<User>().HasOne(u => u.Homeowner).WithOne(h => h.User).HasForeignKey<Homeowner>(h => h.LoginId);
            modelBuilder.Entity<User>().HasOne(u => u.Staff).WithOne(s => s.User).HasForeignKey<Staff>(s => s.LoginId);

            // Admin entity configuration
            modelBuilder.Entity<Admin>().HasKey(a => a.AdminId);
            modelBuilder.Entity<Admin>().HasMany(a => a.Contacts).WithOne(c => c.Admin).HasForeignKey(c => c.AdminId);
            modelBuilder.Entity<Admin>().HasMany(a => a.EventsOrganized).WithOne(ec => ec.OrganizedBy).HasForeignKey(ec => ec.OrganizedById);
            ...
            modelBuilder.Entity<Homeowner>().HasOne(h => h.User).WithOne(u => u.Homeowner).HasForeignKey<Homeowner>(h => h.LoginId);
            ...
            modelBuilder.Entity<Homeowner>().HasMany(h => h.Bills).WithOne(b => b.Homeowner).HasForeignKey(b => b.HomeownerId);

            // Staff entity configuration
            modelBuilder.Entity<Staff>().HasKey(s => s.StaffId);
            modelBuilder.Entity<Staff>().HasOne(s => s.User).WithOne(u => u.Staff).HasForeignKey<Staff>(s => s.LoginId);
            ...
            modelBuilder.Entity<Facility>().HasMany(f => f.Reservations).WithOne(r => r.Facility).HasForeignKey(r => r.FacilityId).OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity<Bill>().HasOne(b => b.Homeowner)
                .WithMany(h => h.Bills)
            ...
            modelBuilder.Entity<Payment>().HasOne(p => p.Bill)
                .WithMany(b => b.Payments)
                .HasForeignKey(p => p.BillId)
                .OnDelete(DeleteBehavior.NoAction);
            modelBuilder.Entity<Payment>().HasOne(p => p.CreditDebitCard)
                .WithMany(cdc => cdc.Payments)
                .HasForeignKey(p => p.CardId)
                .OnDelete(DeleteBehavior.NoAction);
            modelBuilder.Entity<Payment>().HasOne(p => p.OnlineBanking)
